...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0177166795069335 * (T_evap ** 2)) - (0.744385593220354 * T_evap) + 967.062403697992
        oil_density_super = (0.0177166795069335 * ((T_evap + min(superheat_K, 30)) ** 2)) - (0.744385593220354 * (T_evap + min(superheat_K, 30))) + 967.062403697992
