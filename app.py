...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0555952380952371 * (T_evap ** 2)) + (1.2369047619047 * T_evap) + 934.35714285714
        ...
        MinMassFlux = (0.9043 ** 2) * ((density_foroil * 9.81 * ID_m * (oil_density - density_foroil)) ** 0.5)
