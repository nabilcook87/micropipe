...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0705357142857146 * (T_evap ** 2)) + (1.71964285714286 * T_evap) + 922.767857142854
        oil_density_super = (0.0705357142857146 * ((T_evap + min(max(superheat_K, 5), 30)) ** 2)) + (1.71964285714286 * (T_evap + min(max(superheat_K, 5), 30))) + 922.767857142854
