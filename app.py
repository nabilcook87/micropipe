...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.00520509193776553 * (T_evap ** 2)) - (0.748839337715248 * T_evap) + 957.651634911391
        oil_density_super = (0.00520509193776553 * (((T_evap + min(max(superheat_K, 5), 30))) ** 2)) - (0.748839337715248 * (T_evap + min(max(superheat_K, 5), 30))) + 957.651634911391
