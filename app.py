...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.00649999999999995 * (T_evap ** 2)) - (0.74499999999993 * T_evap) + 966.5
        oil_density_super = (0.00649999999999995 * ((T_evap + min(superheat_K, 30)) ** 2)) - (0.74499999999993 * (T_evap + min(superheat_K, 30))) + 966.5
