...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0058557284299865 * (T_evap ** 2)) - (0.759356019635513 * T_evap) + 957.438971628257
        oil_density_super = (0.0058557284299865 * (((T_evap + min(max(superheat_K, 5), 30))) ** 2)) - (0.759356019635513 * (T_evap + min(max(superheat_K, 5), 30))) + 957.438971628257
