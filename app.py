...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0760714285714288 * (T_evap ** 2)) + (1.9845238095238 * T_evap) + 923.714285714282
        oil_density_super = (0.0760714285714288 * ((T_evap + min(max(superheat_K, 5), 30)) ** 2)) + (1.9845238095238 * (T_evap + min(max(superheat_K, 5), 30))) + 923.714285714282
