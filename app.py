...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (-2.92832167830825E-06 * (T_evap ** 4)) - (0.000139439264439378 * (T_evap ** 3)) + (0.0159290015531792 * (T_evap ** 2)) - (0.494146594179947 * T_evap) + 956.477855477128
        oil_density_super = (-2.92832167830825E-06 * ((T_evap + min(max(superheat_K, 5), 30)) ** 4)) - (-0.000139439264439378 * ((T_evap + min(max(superheat_K, 5), 30)) ** 3)) + (0.0159290015531792 * ((T_evap + min(max(superheat_K, 5), 30)) ** 2)) - (0.494146594179947 * (T_evap + min(max(superheat_K, 5), 30))) + 956.477855477128
