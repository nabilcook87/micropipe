...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0769642857142872 * (T_evap ** 2)) + (1.99345238095241 * T_evap) + 922.553571428568
        oil_density_super = (0.0769642857142872 * ((T_evap + min(max(superheat_K, 5), 30)) ** 2)) + (1.99345238095241 * (T_evap + min(max(superheat_K, 5), 30))) + 922.553571428568
