...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0131666666666668 * (T_evap ** 2)) - (0.611666666666551 * T_evap) + 966.5
        oil_density_super = (0.0131666666666668 * ((T_evap + min(superheat_K, 30)) ** 2)) - (0.611666666666551 * (T_evap + min(superheat_K, 30))) + 966.5
