...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0745833333333339 * (T_evap ** 2)) + (1.94583333333334 * T_evap) + 924.874999999997
        oil_density_super = (0.0745833333333339 * ((T_evap + min(max(superheat_K, 5), 30)) ** 2)) + (1.94583333333334 * (T_evap + min(max(superheat_K, 5), 30))) + 924.874999999997
