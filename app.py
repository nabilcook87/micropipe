...
if tool_selection == "Pipe Network Builder":
    ...
    if ID_mm is not None:
        ...
        oil_density_sat = (0.0737500000000004 * (T_evap ** 2)) + (1.77559523809525 * T_evap) + 921.446428571426
        oil_density_super = (0.0737500000000004 * ((T_evap + min(max(superheat_K, 5), 30)) ** 2)) + (1.77559523809525 * (T_evap + min(max(superheat_K, 5), 30))) + 921.446428571426
